...
static void sequential(struct fdescr* dsc, int fdescrlen, Rune* delim, size_t delimlen)
{
    Rune c, last;
    size_t i, d;
...
static void parallel(struct fdescr* dsc, int fdescrlen, Rune* delim, size_t delimlen)
{
    Rune c, d;
    size_t i, m;
    ssize_t last;
...
int main(int argc, char* argv[])
{
    ...
    /* populate delimiters */
    delim_rune = ereallocarray(NULL, utfmemlen(delim, delim_bytelen) + 1, sizeof(*delim_rune));
