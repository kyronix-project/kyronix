...
static void mdchecklist(FILE* listfp, struct crypt_ops* ops, uint8_t* md, size_t sz,
...
int cryptcheck(int argc, char* argv[], struct crypt_ops* ops, uint8_t* md, size_t sz)
{
    FILE* fp;
...
int cryptmain(int argc, char* argv[], struct crypt_ops* ops, uint8_t* md, size_t sz)
{
    int fd;
    int ret = 0;
