...
static char* getarg(char** args, char*** argv)
{
    char* s;
...
static void appendmakeflags(char* text)
{
    int n;
    char *s, *t, *fmt;
...
static int hasargs(int c)
{
    return c == 'f' || c == 'j';
}

static void parseflag(int flag, char** args, char*** argv)
{
    if (hasargs(flag))
        getarg(args, argv);
...
static void parseargv(char** argv, char*** targets, int where, int export)
{
    char* s;
    char* hm = NULL;
...
static void parsemakeflags(void)
{
    int c, n;
    char *s, *flags, **arr;
...
static void parsemakefiles(char** argv)
{
    char *s, *arg;
    int c, hasmake;
 ...
 */
static void enadebug(char* argv[])
{
    int c;
    char* p;
