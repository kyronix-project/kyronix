...
static char* macroinfo(char* name, int* pwhere, Macro** mpp)
{
    char *s, *t;
    int hide, where;
...
void setmacro(char* name, char* val, int where, int export)
{
    int owhere, set;
    char* s;
    Macro* mp;
...
void freeloc(struct loc* loc)
{
    free(loc->fname);
}

static struct loc* getloc(void)
{
    struct input* ip;
...
static int empty(struct input* ip)
{
...
static char* expandmacro(char* name)
{
    char* s;
...
static void replace(char* line, char* repl, char* to)
{
...
static void expandsimple(Target* tp)
{
    char* s;
    Target** p;
    int len, c;
...
static void expansion(Target* tp)
{
 ...
 * it later.
 */
char* expandstring(char* line, Target* tp, struct loc* loc)
{
    int c, n;
    char* s;
...
static struct action readcmd(void)
{
    int n, c;
    struct loc* loc;
    struct action act;
...
static void rule(char* targets[], int ntargets)
{
...
static void assign(char* macros[], int where, int n)
{
    char* defs;
