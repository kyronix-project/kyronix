...
static void find_vertex(const char* name, struct vertex** it, struct vertex** prev)
{
...
static void find_edge(struct vertex* from, const char* to, struct edge** it, struct edge** prev)
{
...
static struct vertex* add_vertex(char* name)
{
...
static struct edge* add_edge(struct vertex* from, struct vertex* to)
{
    struct edge* edge;
    struct edge* prev;
...
static void load_graph(FILE* fp)
{
...
static int sort_graph_visit(struct vertex* u)
{
