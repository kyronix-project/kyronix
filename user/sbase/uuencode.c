...
static unsigned int b64e(unsigned char* b)
{
...
static void uuencodeb64(FILE* fp, const char* name, const char* s)
{
    struct stat st;
    ssize_t n, m = 0;
...
static void uuencode(FILE* fp, const char* name, const char* s)
{
    struct stat st;
