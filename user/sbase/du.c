...
static void printpath(off_t n, const char* path)
{
    if (hflag)
...
static off_t nblks(blkcnt_t blocks)
{
...
static int duplicated(dev_t dev, ino_t ino)
{
    static void* tree;
...
static void du(int dirfd, const char* path, struct stat* st, void* data, struct recursor* r)
{
